...
public class ContactPersonConverter implements Converter {
    ...
    public List<fit5042.tutex.repository.entities.ContactPerson> contactPersonDB; //= propertyManagedBean.getAllContactPeople();
    ...
    public fit5042.tutex.repository.entities.ContactPerson getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue.trim().equals("")) {
            ...
            try {
                ...
                for (fit5042.tutex.repository.entities.ContactPerson c : contactPersonDB) {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return String.valueOf(((fit5042.tutex.repository.entities.ContactPerson) value).getConactPersonId());
        }
    }
}
